...
public class TMemberNode
{
   ...
   public TMemberNode(final String col1, final String col2, final String col3)
   {
      ...
      this.col2 = col2;
      this.col3 = col3;
      this.members = new ArrayList<TMemberNode>();
   }
   ...
   {
      return setFontDetail (colId , bold , false , -1 , 0 , "") ; //$NON-NLS-1$
    }
   ...
   {
      //java.awt.color.BLUE ;
      return setFontDetail (colId , bold , italic , -1 , 0 , "") ; //$NON-NLS-1$
   }
    ...
    * @return the TMember node
    */
   public TMemberNode setFontDetail(final int colId, final boolean bold, final boolean italic, final int color)
   {
    ...
    * @return the TMember node
    */
   public TMemberNode setFontDetail(final int colId, final boolean bold, final boolean italic, final int color, final int size)
   {
    ...
    * @return the TMember node
    */
   public TMemberNode setFontDetail(final int colId, final boolean bold, final boolean italic, final int color, final int size, final String fontName)
   {
    ...
    */
   public void addToStringList(final ArrayList<String> commandList)
   {
    ...
    * @param commandList Where to store members
    */
   protected void internalAddToStringList(final ArrayList<String> commandList)
   {
      ...
      if (this.fontDetails != null)
      {
         for (int c = 0; c < this.fontDetails.size(); c++)
         {
            ...
            // Color is coded as ARGB. convert to BGR
            int colorValue ;
            if (fontDetail.color == -1)
               colorValue = -1 ;
            else  // To be more compatible with another representation of color, get individual color part and convert to BGR
